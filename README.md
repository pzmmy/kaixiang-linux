...
- 🔄 **国内镜像源** — 清华/阿里云/中科大/上海交大/华为云/网易，6 大镜像
- 🐧 **国产发行版** — 支持 Deepin、UOS 统信
- 🎯 **墙内友好** — 砍掉被墙软件，只留能用的
- 📦 **180+ 应用**（中国 50+ / 国际 120+），跨 9 大包管理器
- 🔒 **安全优先** — 只生成命令，用户审查后再执行
- ⌨️ **键盘快捷键** — 选软件不用鼠标
...
> 截图来自本地运行效果。打开 https://pzmmy.github.io/kaixiang-linux/ 在线体验。
...
- [x] 默认镜像源预选清华（国内开箱即用）
- [x] Flatpak 国内镜像（微信/WPS等通过本地镜像安装）
